...
ggplot(exp_df, aes(x=year, y=experiment, fill=factor(active))) + 
  ...
  scale_fill_manual(values=c("2" = "#455f90", "1" = "#342c5c", "0" = "white")) +
...
This project was made possible by the participation of graduate student researchers and substantial grant funding.
