...
[Sampson & Raudenbush (1999)](https://doi.org/10.1086/210356) contend that disorder and crime are both manifestations of low collective efficacy---the capacity for informal social control.
...
* B, D: Disorder and crime are products of low collective efficacy---social control---which is exogenous (C, E).
]
...
* Neighborhood instrumental variables model

* Effect of disorder on crime (A) absent once controlling for collective efficacy (B,D)

* Control for effect of crime on collective efficacy (E), but assume no effect of disorder on collective efficacy (C)
]

.pull-right[
[**Keizer et al. (2008)**](https://doi.org/10.1126/science.1161405)

* Multiple field experiments in single sites
...
Engaging in social control is a prosocial behavior

Collective efficacy predicts non-sanctioning prosocial behavior—returning lost letters, providing CPR (Sampson, 2008)
