...
To answer these questions, this study links field experiments embedded in Seattle neighborhoods 
...
We aren't testing any path at all here. We could use the original diagram and add a box for prosocial action and an association link with collective efficacy.
...
Notes: We really are testing A. But we're also testing something else: Does disorder impact prosocial behavior, which is a product of collective efficacy. Add a new box for that? We are also observationally testing D.
...
Restrictied coefficient table, maybe model diagram with standardized values?