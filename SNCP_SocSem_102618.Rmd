...
Manipulated disorder and observed norm violation using field experiments in Grongingen, the Netherlands. Diverse range of interventions show a robust relationship.
...
Models of crime, disorder, and collective efficacy in Chicago neighborhoods, using survey-measured collective efficacy and a novel objective measure of disorder: Video of street segments.
...
* Control crime impact on collective efficacy (E), but assume no disorder feedback on collective efficacy (C)
...
Collective efficacy is related to many prosocial behaviors:<sup>1</sup>
...
24 letters—8 to each address—were dropped in each census tract:
...
* Test of effect of interpersonal context of norm violation on sanctioning (L).

* Captures association between collective efficacy and sanctioning (I).
]
...
.pull-right[
1. Disorder had no impact on theft (A).
   * High statistical power compared to Keizer.

2. Disorder appears to attenuate low-risk, low-cost prosocial actions—mailing letters, throwing away litter—and may impact sanctioning as well (B).
   * Consistent with indirect Broken Windows pathway
   * Possible feedback effect on collective efficacy (B)
]
...
.pull-right[
3. Collective efficacy predicts some low-risk prosocial action—mailing lost letters—but not higher risk actions—sanctioning (C,D).
   * Collective efficacy research should explore context of interventions.<sup>1</sup> 
   * Not strong evidence against collective efficacy: Low power.

4. Context matters for prosocial behavior.
   * Target characteristics impact sanctioning
   * Characteristics of letters impact mailing
   
.footnote[
[1] Note that while separated here for analytical purposes, *disorder is a context* as well.
]
...
5. This may suggest perceived costs—such as risk—are important but neglected considerations for neighborhood theories of crime.
   * Collective efficacy is correlated with risk factors—such as retaliation for sanctions
   * Disorder may be a signal for risks or other costs<sup>1</sup>
   * Disorder may signal that interventions will have limited benefit
   
*We know relatively little about the activation of prosocial behavior*
